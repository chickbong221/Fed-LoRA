...
# TODO Fix all of the values related to the FedAvg -> FedExAgg
class Server(BaseServer):
    ...
    def __init__(self,
        ...
        if self._cfg.federate.share_local_model \
            ...
            model.to(device)
        # Build aggregator
        # TODO Make sure the aggregator call the right aggregator FedExAgg
        ...
        if self.check_client_join_in():
            ...
            if 'client_resource' in self._cfg.federate.join_in_info:
                ...
                if self._cfg.backend == 'torch':
                    ...
                    # TODO: calculate model size for TF Model NOTME
                    model_size = 1.0
